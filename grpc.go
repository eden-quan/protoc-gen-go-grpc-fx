...
const (
	...
	configPackage    = protogen.GoImportPath("github.com/eden-quan/go-biz-kit/config")
	defPackage       = protogen.GoImportPath("github.com/eden-quan/go-biz-kit/config/def")
	injectionPackage = protogen.GoImportPath("github.com/eden-quan/go-biz-kit/injection")
...
func generateFile(gen *protogen.Plugin, file *protogen.File) *protogen.GeneratedFile {
	...
	file.Proto.Dependency = append(file.Proto.Dependency, "fmt")
...
func generateFileContent(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile) {
	...
	g.P("var _ = new(", defPackage.Ident("Server"), ")")
	g.P("var _ = new(", clientPackage.Ident("RegisterGRPCClientFactoryType"), ")")
...
func genService(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, service *protogen.Service) {
	...
	g.P("// Generate Injection")
	g.P("type register", serverType, "GRPCResult struct{}")
	g.P()
	g.P("func (*register", serverType, "GRPCResult) String() string {")
	g.P("    return \"", serverType, "GRPCServer\"")
	g.P("}")
	g.P()

	g.P("func Register", serverType, "GRPCProvider(newer interface{}) []interface{} {")
	g.P("    return []interface{}{")
	g.P("// For provide dependency")
	g.P("fx.Annotate(")
	g.P("    newer,")
	g.P("    fx.As(new(", serverType, ")),")
	g.P("),")
	g.P("// For create instance")
	g.P("fx.Annotate(")
	g.P("    register", serverType, "ProviderImpl,")
	g.P("    fx.As(new(fmt.Stringer)),")
	g.P("    fx.ResultTags(`group:\"grpc_register\"`),")
	g.P("),")
	g.P("}")
	g.P("}")

	g.P()
	g.P("// register", serverType, "ProviderImpl use to trigger register")
	g.P("func register", serverType, "ProviderImpl(s grpc.ServiceRegistrar, srv ", serverType, ") *register", serverType, "GRPCResult {")
	g.P("register", serverType, "(s, srv)")
	g.P("return &register", serverType, "GRPCResult{}")
	g.P("}")
